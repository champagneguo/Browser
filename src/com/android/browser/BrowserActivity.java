...
public class BrowserActivity extends NTStatusBarFakeDimActivity {
    ...
    private boolean shouldIgnoreIntents() {
        ...
        /// M: Should ignore intents. @{
        if (ignore) {
            Xlog.w(XLOGTAG, "screenOn=" + mPowerManager.isScreenOn()
                + ", RestrictedInputMode="
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        mTintManager.setStatusBarTintEnabled(newConfig.orientation == Configuration.ORIENTATION_PORTRAIT);
    }
