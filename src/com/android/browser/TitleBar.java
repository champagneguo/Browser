...
public class TitleBar extends RelativeLayout {
    ...
    protected ImageView mNewTabBtn;
    protected TextView mTabCountView;
    private View mBtnContainerLeft, mBtnContainerRight;
    ...
    private void initLayout(Context context) {
        ...
        mBtnContainerLeft = findViewById(R.id.titlebar_btns_at_left);
        mBtnContainerRight = findViewById(R.id.titlebar_btns_at_right);
        mBtnContainerLeft.setVisibility(View.GONE);
        mBtnContainerRight.setVisibility(View.GONE);

        mBackwardBtn = (ImageView)findViewById(R.id.back_btn);
		mBackwardBtn.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
        ...
        mForwardBtn.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View arg0) {
                Toast.makeText(mUiController.getActivity(),
        ...
        mNewTabBtn = (ImageView)findViewById(R.id.new_tab_btn);
        mNewTabBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                mUiController.openTabToHomePage();
            }
        });
        mNewTabBtn.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View arg0) {
                Toast.makeText(mUiController.getActivity(),
        ...
        mTabCountView = (TextView)findViewById(R.id.tabcount_view);
        mTabCountView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ((PhoneUi) mBaseUi).toggleNavScreen();
            }
        });
        mTabCountView.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View arg0) {
                Toast.makeText(mUiController.getActivity(),
    ...
    protected void onConfigurationChanged(Configuration config) {
        ...
        if (config.orientation == Configuration.ORIENTATION_LANDSCAPE){
            mBtnContainerLeft.setVisibility(View.VISIBLE);
            mBtnContainerRight.setVisibility(View.VISIBLE);
        }else{
            mBtnContainerLeft.setVisibility(View.GONE);
            mBtnContainerRight.setVisibility(View.GONE);
        }
    ...
    public void tabCountChanged(int tabCount) {
        if (mTabCountView != null) mTabCountView.setText(Integer.toString(tabCount));
    }

    public void changeBackForwardState(boolean back, boolean forward) {
        mBackwardBtn.setEnabled(back);
        mForwardBtn.setEnabled(forward);
    }
}
