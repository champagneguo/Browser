                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                     ...
                     public void onClick(DialogInterface dialog, int which) {
                         if (which == DialogInterface.BUTTON_POSITIVE) {
                             View clearBtn = getActivity().findViewById(R.id.btn_clear_history);
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            if (groupPosition >= super.getGroupCount()) {
                ...
                if (null == convertView) {
                    ...
                    groupView = factory.inflate(R.layout.history_header, null);
                } else {
                    groupView = convertView;
                }
                TextView item = (TextView)groupView.findViewById(R.id.group_title);
                ImageView indicator = (ImageView)groupView.findViewById(R.id.expander_img_right);
                item.setText(R.string.tab_most_visited);
                indicator.setBackgroundResource(isExpanded ? R.drawable.group_indicator_close :
                    R.drawable.group_indicator_open);
                return groupView;
            }
